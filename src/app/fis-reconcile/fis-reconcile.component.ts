...
@Component({
    selector: 'rec-fis-reconcile',
    templateUrl: './fis-reconcile.component.html',
    styleUrls: ['./fis-reconcile.component.css']
})
export class FisReconcileComponent implements OnInit  {
